...
$(document).ready(function () {
    ...
    <div class="card" style="">
        ...
        <div class="empresa-div">
            <div class="card" style=";">
                <img src="<span class="card-text text-muted" style="font-size: 15px;">Protege la salud de tu mascota</span>
                    <span class="card-text text-muted float-right" style="font-size: 18px;"><i class="fas fa-paw"></i><i class="fas fa-paw"></i><i class="fas fa-star" style="color: #FFC300;"></i><i class="fas fa-star" style="color: #FFC300;"></i><i class="fas fa-star" style="color: #FFC300;"></i></span>./static/img/logotipo/Logotipo-1.png" style="width:100%;height: 22.5VH;">
                <div class="card-body p-2">
