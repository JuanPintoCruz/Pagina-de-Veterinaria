            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h2 class="page-title"><i class=" ti-user"></i><span> Registro Usuario  </span></h2>
                                <br>
                                <!--<ol class="breadcrumb">
                                            ...
                                            <form role="form">
                                                <div class="d-md-flex">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <h4 class="m-t-0 header-title"><i class=" ti-crown mr-1"></i><span> Nivel de privilegios</span></h4>                                                               
                                                                <div class="form-group row p-2">
                                                                    <div class="custom-control custom-radio" style="left:30px">
                                                                        <input type="radio" id="customRadio1" name="customRadio" class="custom-control-input">
                                                                        <label class="custom-control-label" for="customRadio1"><span class="label label-success mr-1">Nivel 1</span><span>Control total de Sistema</span></label>
                                                                    </div>
                                                                    <div class="custom-control custom-radio" style="left:30px">
                                                                        <input type="radio" id="customRadio1" name="customRadio" class="custom-control-input">
                                                                        <label class="custom-control-label" for="customRadio1"><span class="label label-primary mr-1">Nivel 2</span><span>Permiso de registro y actualizacion</span></label>
                                                                    </div>
                                                                    <div class="custom-control custom-radio" style="left:30px">
                                                                        <input type="radio" id="customRadio1" name="customRadio" class="custom-control-input">
                                                                        <label class="custom-control-label" for="customRadio1"><span class="label label-info mr-1">Nivel 3</span><span>Permiso para registrar</span></label>
                                                                    </div>                                                               
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="table-box">
                                                                <div class="table-detail d-flex justify-content-center align-items-center">
                                                                    <img src="static/img/avatar-6.jpg" class="thumb-lg rounded-circle"  style="border: 5px solid" alt="img">
                                                                </div>
                                                            </div>
