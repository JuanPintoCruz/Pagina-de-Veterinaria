...
<body>
            ...
            <div id="carouselExampleIndicators" class="carousel slide mb-5" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active ">
                        ...
                        <div class="container">
                           <h1 class="titulo-primero" style="color:white; font-size:3.2rem; position: absolute; top: 310px; left: 0; right: 0; margin: 0 auto; text-align: center; text-shadow: 
                                    -2px -2px 0 #000,  
                                    2px -2px 0 #000,
                                    -2px 2px 0 #000,
                                    2px 2px 0 #000; animation: appearFromSide 1s ease;">
                              "Amor incondicional para tus mascotas <span style="display: block;">¡Visítanos hoy!</span>
                            </h1>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img class="d-block" src="static/img/image.jpg" alt="First slide"   style="height: 85vh; width: 100%;object-fit: cover;" >
                        <div class="container">
                        <h1 class="titulo-primero" style="color:white; font-size:3.2rem; position: absolute; top: 310px; left: 0; right: 0; margin: 0 auto; text-align: center; text-shadow: 
                                    -2px -2px 0 #000,  
                                    2px -2px 0 #000,
    ...
    <form action="" method="post">
        <div class="card" style="color:#665C5C;">
            <!-- cardbody> -->
            <div class="card-body" style="border-radius: 5px; background: linear-gradient(to right, white 40%, rgb(237,239,237) 45%, rgb(222,227,223) 50%);">
                <h3 style="font-family: Franklin Gothic;">Utiliza tu ubicación actual y encuentra la veterinaria más cercana.</h3>
                <div class="row">
                    <div class="form-group col-lg-4">
                        <select class="form-control" id="departamento" style="font-size:1.3.2rem; color:white; border-radius: 10px;background-color: rgba(52, 165, 245);font-family: Franklin Gothic; ">
                    ...
                    <div class="form-group col-lg-4">
                        <select class="form-control" id="distrito" disabled="true" style="font-size:1.3.2rem; color:white; border-radius: 10px;background-color: rgba(52, 165, 245);font-family: Franklin Gothic;">
                            <option>Seleccióne Distrito</option>
                        </select>
                    </div>
                    <div class="form-group col-lg-4">
                        <button type="button" class="btn btn-dark" style="font-size:1.3.2rem; width: 100%;border-radius: 10px;font-family: Franklin Gothic;" data-toggle="modal" data-target="#exampleModalCenter">Utiliza Tu Ubicación Actual  <i class="fas fa-search-location"></i></button>
                    </div>
                </div>
            </div>
        </div>
...
<div class="contenedor p-5 col-md-10">
            ...
            <div class="text-center">
              <img src="static/img/buscador.png" alt="">
            </div>
            <div class=" row">
                <div class="col-lg-6 col-12 pt-3">
                    <h3 style="font-family: Franklin Gothic;"><img src="static/img/ubicacion.png" width="50" height="90" alt="ubicacion"> La victoria,Lima Perú</h3>
                </div>
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <button type="submit" class="btn btn-primary">
                                ...
                                <span class="d-none d-md-inline ml-1">Buscar</span> <!-- Texto "Buscar" visible en pantallas medianas y grandes -->
                            </button>
                        </div>
                    </div>
                </form>
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-4 mb-3">
              <div class="contenido-caja h-100">
                  <img src="static/img/logotipo/Logotipo-1.jpg" style="width:100%;height: 22.5vh;" alt="Imagen 1">
                  <div class="card-body p-2">
                      <div class="float-left">
                          <span class="card-text text-muted" style="font-size: 18px;">Veterinaria del Señor</span>
                          <br>
                          <span class="card-text text-muted" style="font-size: 15px;">Protege la salud de tu mascota</span>
                      </div>
                      <div class="  float-right">
                          <span class="card-text text-muted" style="font-size: 25px;">09:00 - 18:00</span>
                          <br>
                          <span class="card-text text-muted" style="font-size: 18px;"><i class="fas fa-paw"></i><i class="fas fa-paw"></i><i class="fas fa-star" style="color: #FFC300;"></i><i class="fas fa-star" style="color: #FFC300;"></i><i class="fas fa-star" style="color: #FFC300;"></i></span>
                         <br>
                         <br>
          ...
          <div class="col-12 col-sm-6 col-md-4 mb-3">
              <div class="contenido-caja h-100">
                  <img src="static/img/logotipo/Logotipo-2.jpg" style="width:100%;height: 22.5vh;" alt="Imagen 1">
                  <div class="card-body p-2">
                      <div class="float-left">
                          <span class="card-text text-muted" style="font-size: 18px;">Veterinaria del Señor</span>
                          <br>
          ...
          <div class="col-12 col-sm-6 col-md-4 mb-3">
              <div class="contenido-caja h-100">
                  <img src="static/img/logotipo/Logotipo-3.jpg" style="width:100%;height: 22.5vh;" alt="Imagen 1">
                  <div class="card-body p-2">
                      <div class="float-left">
                          <span class="card-text text-muted" style="font-size: 18px;">Veterinaria del Señor</span>
                          <br>
          ...
          <div class="col-12 col-sm-6 col-md-4 mb-3">
              <div class="contenido-caja h-100">
                  <img src="static/img/logotipo/Logotipo-4.jpg" style="width:100%;height: 22.5vh;" alt="Imagen 1">
                  <div class="card-body p-2">
                      <div class="float-left">
                          <span class="card-text text-muted" style="font-size: 18px;">Veterinaria del Señor</span>
                          <br>
          ...
          <div class="col-12 col-sm-6 col-md-4 mb-3">
              <div class="contenido-caja h-100">
                  <img src="static/img/logotipo/Logotipo-5.jpg" style="width:100%;height: 22.5vh;" alt="Imagen 1">
                  <div class="card-body p-2">
                      <div class="float-left">
                          <span class="card-text text-muted" style="font-size: 18px;">Veterinaria del Señor</span>
                          <br>
          ...
          <div class="col-12 col-sm-6 col-md-4 mb-3">
              <div class="contenido-caja h-100">
                  <img src="static/img/logotipo/Logotipo-6.jpg" style="width:100%;height: 22.5vh;" alt="Imagen 1">
                  <div class="card-body p-2">
                      <div class="float-left">
                          <span class="card-text text-muted" style="font-size: 18px;">Veterinaria del Señor</span>
                          <br>
          ...
          <div class="col-12 col-sm-6 col-md-4 mb-3">
              <div class="contenido-caja h-100">
                  <img src="static/img/logotipo/Logotipo-7.jpg" style="width:100%;height: 22.5vh;" alt="Imagen 1">
                  <div class="card-body p-2">
                      <div class="float-left">
                          <span class="card-text text-muted" style="font-size: 18px;">Veterinaria del Señor</span>
                          <br>
          ...
          <div class="col-12 col-sm-6 col-md-4 mb-3">
              <div class="contenido-caja h-100">
                  <img src="static/img/logotipo/Logotipo-8.jpg" style="width:100%;height: 22.5vh;" alt="Imagen 1">
                  <div class="card-body p-2">
                      <div class="float-left">
                          <span class="card-text text-muted" style="font-size: 18px;">Veterinaria del Señor</span>
                          <br>
          ...
          <div class="col-12 col-sm-6 col-md-4 mb-3">
              <div class="contenido-caja h-100">
                  <img src="static/img/logotipo/Logotipo-9.jpg" style="width:100%;height: 22.5vh;" alt="Imagen 1">
                  <div class="card-body p-2">
                      <div class="float-left">
                          <span class="card-text text-muted" style="font-size: 18px;">Veterinaria del Señor</span>
                          <br>
          ...
          <div class="col-12 col-sm-6 col-md-4 mb-3">
              <div class="contenido-caja h-100">
                  <img src="static/img/logotipo/Logotipo-10.jpg" style="width:100%;height: 22.5vh;" alt="Imagen 1">
                  <div class="card-body p-2">
                      <div class="float-left">
                          <span class="card-text text-muted" style="font-size: 18px;">Veterinaria del Señor</span>
                          <br>
          ...
          <div class="col-12 col-sm-6 col-md-4 mb-3">
              <div class="contenido-caja h-100">
                  <img src="static/img/logotipo/Logotipo-11.jpg" style="width:100%;height: 22.5vh;" alt="Imagen 1">
                  <div class="card-body p-2">
                      <div class="float-left">
                          <span class="card-text text-muted" style="font-size: 18px;">Veterinaria del Señor</span>
                          <br>
          ...
          <div class="col-12 col-sm-6 col-md-4 mb-3">
              <div class="contenido-caja h-100">
                  <img src="static/img/logotipo/Logotipo-12.jpg" style="width:100%;height: 22.5vh;" alt="Imagen 1">
                  <div class="card-body p-2">
                      <div class="float-left">
                          <span class="card-text text-muted" style="font-size: 18px;">Veterinaria del Señor</span>
                          <br>
          ...
          <div class="col-12 col-sm-6 col-md-4 mb-3">
              <div class="contenido-caja h-100">
                  <img src="static/img/logotipo/Logotipo-13.jpg" style="width:100%;height: 22.5vh;" alt="Imagen 1">
                  <div class="card-body p-2">
                      <div class="float-left">
                          <span class="card-text text-muted" style="font-size: 18px;">Veterinaria del Señor</span>
                          <br>
          ...
          <div class="col-12 col-sm-6 col-md-4 mb-3">
              <div class="contenido-caja h-100">
                  <img src="static/img/logotipo/Logotipo-14.jpg" style="width:100%;height: 22.5vh;" alt="Imagen 1">
                  <div class="card-body p-2">
                      <div class="float-left">
                          <span class="card-text text-muted" style="font-size: 18px;">Veterinaria del Señor</span>
                          <br>
          ...
          <div class="col-12 col-sm-6 col-md-4 mb-3">
              <div class="contenido-caja h-100">
                  <img src="static/img/logotipo/Logotipo-15.jpg" style="width:100%;height: 22.5vh;" alt="Imagen 1">
                  <div class="card-body p-2">
                      <div class="float-left">
                          <span class="card-text text-muted" style="font-size: 18px;">Veterinaria del Señor</span>
                          <br>
          ...
          <div class="col-12 col-sm-6 col-md-4 mb-3">
              <div class="contenido-caja h-100">
                  <img src="static/img/logotipo/Logotipo-16.jpg" style="width:100%;height: 22.5vh;" alt="Imagen 1">
                  <div class="card-body p-2">
                      <div class="float-left">
                          <span class="card-text text-muted" style="font-size: 18px;">Veterinaria del Señor</span>
                          <br>
          ...
          <div class="col-12 col-sm-6 col-md-4 mb-3">
              <div class="contenido-caja h-100">
                  <img src="static/img/logotipo/Logotipo-17.jpg" style="width:100%;height: 22.5vh;" alt="Imagen 1">
                  <div class="card-body p-2">
                      <div class="float-left">
                          <span class="card-text text-muted" style="font-size: 18px;">Veterinaria del Señor</span>
                          <br>
          ...
          <div class="col-12 col-sm-6 col-md-4 mb-3">
              <div class="contenido-caja h-100">
                  <img src="static/img/logotipo/Logotipo-18.jpg" style="width:100%;height: 22.5vh;" alt="Imagen 1">
                  <div class="card-body p-2">
                      <div class="float-left">
                          <span class="card-text text-muted" style="font-size: 18px;">Veterinaria del Señor</span>
                          <br>
          ...
          <div class="col-12 col-sm-6 col-md-4 mb-3">
              <div class="contenido-caja h-100">
                  <img src="static/img/logotipo/Logotipo-19.jpg" style="width:100%;height: 22.5vh;" alt="Imagen 1">
                  <div class="card-body p-2">
                      <div class="float-left">
                          <span class="card-text text-muted" style="font-size: 18px;">Veterinaria del Señor</span>
                          <br>
          ...
          <div class="col-12 col-sm-6 col-md-4 mb-3">
              <div class="contenido-caja h-100">
                  <img src="static/img/logotipo/Logotipo-20.jpg" style="width:100%;height: 22.5vh;" alt="Imagen 1">
                  <div class="card-body p-2">
                      <div class="float-left">
                          <span class="card-text text-muted" style="font-size: 18px;">Veterinaria del Señor</span>
                          <br>
          ...
          <div class="col-12 col-sm-6 col-md-4 mb-3">
              <div class="contenido-caja h-100">
                  <img src="static/img/logotipo/Logotipo-21.jpg" style="width:100%;height: 22.5vh;" alt="Imagen 1">
                  <div class="card-body p-2">
                      <div class="float-left">
                          <span class="card-text text-muted" style="font-size: 18px;">Veterinaria del Señor</span>
                          <br>
...
<section class="section-Contenido" style="background-image: url(static/img/foto-register.png); height: 73%; position: relative; background-size: cover; background-position: center;">
    <div>
        <div style="padding-top: 5%;">
            <div class="col-lg-12">
                <div class="form-group text-center pt-4" >
                    <br><br><br><br><br><br><br><br>
                    <h3 class="m-t-0 header-title" style="font-family: Franklin Gothic;">
                        <span style="font-size: 50px; color: white; text-shadow: -1px -1px 0 #808080, 1px -1px 0 #808080, -1px 1px 0 #808080, 1px 1px 0 #808080;"><b>REGÍSTRATE AHORA!</b></span>
                    </h3>
                    <h4 style="font-family: Franklin Gothic;">
                        <span style="font-size: 25px; color: #555555; text-shadow: -1px -1px 0 #f0f0f0, 1px -1px 0 #f0f0f0, -1px 1px 0 #f0f0f0, 1px 1px 0 #f0f0f0;">
                            Sé el primero en recibir nuestras ofertas y novedades
                        </span>
                    </h4>
