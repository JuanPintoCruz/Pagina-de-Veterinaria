                                ...
                                <div class="card-box p-1">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <a href="#custom-modal" class="btn btn-default btn-md waves-effect waves-light m-b-30" data-animation="fadein" data-plugin="custommodal"
                                               data-overlaySpeed="200" data-overlayColor="#36404a"><i class="md md-add"></i>Nueva Especie</a>
                                    ...
                                    <!-- Modal -->
                                        <div id="custom-modal" class="modal-demo">
                                            ...
                                            <h4 class="custom-modal-title">Nuevo Especie</h4>
                                            <div class="custom-modal-text">
                                                <div class="col-12 mb-4">
                                                    <p class="text-left">Especie</p>
                                                    <input type="text" class="form-control" placeholder="">
                                                </div>
                                                <div class="text-right">
                                                    <button type="button" class="btn btn-inverse btn-rounded waves-effect waves-light">Cerrar</button>
